...
export function AdminAuthSettings({
  ...
  // SSO (optional). Social/OAuth toggles are portal-only — teams use SSO
  // for their company identity, not consumer social. So the last-method
  // guard considers only password against the magic-link baseline.
  const enabledMethodCount = 1 + (passwordEnabled ? 1 : 0)
